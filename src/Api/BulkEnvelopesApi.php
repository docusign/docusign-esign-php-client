...
class BulkEnvelopesApi
{
    ...
    */
     ...
     * @param  \DocuSign\eSign\Api\Options\BulkEnvelopesApiGetBulkSendBatchEnvelopesOptions  $options for modifying the behavior of the function. (optional)
     *
     * @throws ApiException on non-2xx response
     * @return \DocuSign\eSign\Model\EnvelopesInformation
     */
    public function getBulkSendBatchEnvelopes($account_id, $bulk_send_batch_id, \DocuSign\eSign\Api\Options\BulkEnvelopesApiGetBulkSendBatchEnvelopesOptions $options = null)
    {
     ...
     */
    public function getBulkSendBatchEnvelopesWithHttpInfo($account_id, $bulk_send_batch_id, \DocuSign\eSign\Api\Options\BulkEnvelopesApiGetBulkSendBatchEnvelopesOptions $options = null): array
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null) {
     ...
     *
     * @param ?string $account_id The external account number (int) or account ID Guid.
     * @param  \DocuSign\eSign\Api\Options\BulkEnvelopesApiGetBulkSendBatchesOptions  $options for modifying the behavior of the function. (optional)
     *
     * @throws ApiException on non-2xx response
     * @return \DocuSign\eSign\Model\BulkSendBatchSummaries
     */
    public function getBulkSendBatches($account_id, \DocuSign\eSign\Api\Options\BulkEnvelopesApiGetBulkSendBatchesOptions $options = null)
    {
     ...
     */
    public function getBulkSendBatchesWithHttpInfo($account_id, \DocuSign\eSign\Api\Options\BulkEnvelopesApiGetBulkSendBatchesOptions $options = null): array
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null) {
