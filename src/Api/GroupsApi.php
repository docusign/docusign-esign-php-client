...
class GroupsApi
{
    ...
    */
     ...
     * @param ?string $account_id The external account number (int) or account ID Guid.
     * @param ?string $group_id The ID of the group being accessed.
     * @param  \DocuSign\eSign\Api\Options\GroupsApiListGroupUsersOptions  $options for modifying the behavior of the function. (optional)
     *
     * @throws ApiException on non-2xx response
     * @return \DocuSign\eSign\Model\UsersResponse
     */
    public function listGroupUsers($account_id, $group_id, \DocuSign\eSign\Api\Options\GroupsApiListGroupUsersOptions $options = null)
    {
     ...
     * @return array of \DocuSign\eSign\Model\UsersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listGroupUsersWithHttpInfo($account_id, $group_id, \DocuSign\eSign\Api\Options\GroupsApiListGroupUsersOptions $options = null): array
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null) {
     ...
     *
     * @param ?string $account_id The external account number (int) or account ID Guid.
     * @param  \DocuSign\eSign\Api\Options\GroupsApiListGroupsOptions  $options for modifying the behavior of the function. (optional)
     *
     * @throws ApiException on non-2xx response
     * @return \DocuSign\eSign\Model\GroupInformation
     */
    public function listGroups($account_id, \DocuSign\eSign\Api\Options\GroupsApiListGroupsOptions $options = null)
    {
     ...
     * @return array of \DocuSign\eSign\Model\GroupInformation, HTTP status code, HTTP response headers (array of strings)
     */
    public function listGroupsWithHttpInfo($account_id, \DocuSign\eSign\Api\Options\GroupsApiListGroupsOptions $options = null): array
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null) {
