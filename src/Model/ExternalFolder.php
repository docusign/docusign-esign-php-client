...
class ExternalFolder implements ModelInterface, ArrayAccess
{
     ...
     * Sets error_details
     *
     * @param \DocuSign\eSign\Model\ExternalDocServiceErrorDetails $error_details This object describes errors that occur. It is only valid for responses and ignored in requests.
     *
     * @return $this
     */
