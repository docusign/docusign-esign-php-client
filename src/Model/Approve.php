...
/**
 * Approve Class Doc Comment
 *
 * @category    Class
 * @description A tab that allows the recipient to approve documents without placing a signature or initials on the document.
 * @package     DocuSign\eSign
 * @author      Swagger Codegen team <apihelp@docusign.com>
 * @license     The DocuSign PHP Client SDK is licensed under the MIT License.
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Approve implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'approve';
     ...
     * Sets button_text
     *
     * @param ?string $button_text Specifies the approval text displayed in the tab.
     *
     * @return $this
     */
