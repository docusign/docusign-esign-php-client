 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Signer implements ArrayAccess
{
    /**
    ...
    /**
      * $is_bulk_recipient When set to **true**, this signer is a bulk recipient and the recipient information is contained in a bulk recipient file. \n\nNote that when this is true the email and name for the recipient becomes bulk@recipient.com and \"Bulk Recipient\". These fields can not be changed for the bulk recipient.
      * @var string
      */
    protected $is_bulk_recipient;
    
    /**
      * $bulk_recipients_uri Contains a URI for an endpoint that allows you to easily retrieve bulk recipient information.
      * @var string
      */
    protected $bulk_recipients_uri;
    ...
    public function __construct(array $data = null)
    {
        if ($data != null) {
            ...
            $this->is_bulk_recipient = $data["is_bulk_recipient"];
            $this->bulk_recipients_uri = $data["bulk_recipients_uri"];
     ...
     * @param string $require_signer_certificate Sets the type of signer certificate required for signing. If left blank, no certificate is required. Only one type of certificate can be set for a signer. The possible values are:\n\n* docusign_express – Requires a DocuSign Express certificate.\n* safe – Requires a SAFE-BioPharma certificate.\n* open_trust – Requires an OpenTrust certificate. \n\n**Important**: There are certain rules and restrictions that must be followed when requiring OpenTrust digital signatures. See [ML:OpenTrust Rules and Restrictions] for more information.
     * @return $this
     */
    ...
    {
        return $this->is_bulk_recipient;
    }
  
    /**
     * Sets is_bulk_recipient
     * @param string $is_bulk_recipient When set to **true**, this signer is a bulk recipient and the recipient information is contained in a bulk recipient file. \n\nNote that when this is true the email and name for the recipient becomes bulk@recipient.com and \"Bulk Recipient\". These fields can not be changed for the bulk recipient.
     * @return $this
     */
    public function setIsBulkRecipient($is_bulk_recipient)
    {
        
        $this->is_bulk_recipient = $is_bulk_recipient;
        return $this;
    }
    ...
    {
        return $this->bulk_recipients_uri;
    }
    ...
    public function setBulkRecipientsUri($bulk_recipients_uri)
    {
        ...
        $this->bulk_recipients_uri = $bulk_recipients_uri;
        return $this;
    }
    ...
    /**
     * Sets email
     * @param string $email Email id of the recipient. Notification of the document to sign is sent to this email id. \n\nMaximum length: 100 characters.
     * @return $this
     */
