...
class DiagnosticsSettingsInformation implements ArrayAccess
{
    ...
    /**
      * $api_request_logging When set to **true**, enables API request logging for the user.
      * @var string
      */
    protected $api_request_logging;
    
    /**
      * $api_request_log_max_entries Specifies the maximum number of API requests to log.
      * @var string
      */
    protected $api_request_log_max_entries;
    
    /**
      * $api_request_log_remaining_entries Indicates the remaining number of API requests that can be logged.
      * @var string
      */
    protected $api_request_log_remaining_entries;
    ...
    {
        if ($data != null) {
            $this->api_request_logging = $data["api_request_logging"];
            $this->api_request_log_max_entries = $data["api_request_log_max_entries"];
            $this->api_request_log_remaining_entries = $data["api_request_log_remaining_entries"];
        }
    }
    ...
    {
        return $this->api_request_logging;
    }
    ...
    public function setApiRequestLogging($api_request_logging)
    {
        ...
        $this->api_request_logging = $api_request_logging;
        return $this;
    }
    ...
    {
        return $this->api_request_log_max_entries;
    }
    ...
    public function setApiRequestLogMaxEntries($api_request_log_max_entries)
    {
        ...
        $this->api_request_log_max_entries = $api_request_log_max_entries;
        return $this;
    }
    ...
    {
        return $this->api_request_log_remaining_entries;
    }
    ...
    public function setApiRequestLogRemainingEntries($api_request_log_remaining_entries)
    {
        ...
        $this->api_request_log_remaining_entries = $api_request_log_remaining_entries;
        return $this;
    }
