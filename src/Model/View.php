...
class View implements ModelInterface, ArrayAccess
{
     ...
     * @return ?string
     */
    public function getRequiredRead()
    {
        return $this->container['required_read'];
    }
     ...
     * @return $this
     */
    public function setRequiredRead($required_read)
    {
        $this->container['required_read'] = $required_read;
