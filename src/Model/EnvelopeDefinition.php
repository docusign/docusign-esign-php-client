 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EnvelopeDefinition implements ArrayAccess
{
    /**
    ...
    /**
      * $event_notification 
      * @var \DocuSign\eSign\Model\EventNotification
      */
    protected $event_notification;
    
    /**
      * $allow_recipient_recursion When set to **true**, this enables the Recursive Recipients feature and allows a recipient to appear more than once in the routing order.
      * @var string
      */
    protected $allow_recipient_recursion;
    ...
    /**
      * $email_blurb Optional element. This is the same as the email body. If specified it is included in email body for all envelope recipients. This can be a maximum of 10000 characters
      * @var string
      */
    ...
    /**
      * $brand_id This sets the brand profile format used for the envelope. The value in the string is the brandId associated with the profile. Account branding must be enabled for the account to use this option.
      * @var string
      */
    protected $brand_id;
    ...
    public function __construct(array $data = null)
    {
        if ($data != null) {
            ...
            $this->event_notification = $data["event_notification"];
            $this->allow_recipient_recursion = $data["allow_recipient_recursion"];
            $this->template_id = $data["template_id"];
            $this->template_roles = $data["template_roles"];
            $this->composite_templates = $data["composite_templates"];
     ...
     * @param \DocuSign\eSign\Model\EventNotification $event_notification 
     * @return $this
     */
    ...
    {
        return $this->allow_recipient_recursion;
    }
    ...
    public function setAllowRecipientRecursion($allow_recipient_recursion)
    {
        ...
        $this->allow_recipient_recursion = $allow_recipient_recursion;
        return $this;
    }
    ...
    {
        return $this->template_roles;
    }
  
    /**
     * Sets template_roles
     * @param \DocuSign\eSign\Model\TemplateRole[] $template_roles Specifies the template recipients. Each roleName in the template must have a recipient assigned to it. This is made up elements:\n\n* email - The recipient’s email address.\n* name - The recipient’s name.\n* roleName - The template roleName associated with the recipient.\n* clientUserId - Optional, this sets if the signer is This specifies if the recipient is embedded or remote. If the clientUserId is not null then the recipient is embedded. Note that if a ClientUserId is used and the account settings SignerMustHaveAccount or SignerMustLoginToSign are true, an error is generated on sending.\n* defaultRecipient - Optional, When set to **true**, this recipient is the default recipient and any tabs generated by the transformPdfFields option are mapped to this recipient.\n* routingOrder - This specifies the routing order of the recipient in the envelope.\n* accessCode - This optional element specifies the access code a recipient has to enter to validate the identity. This can be a maximum of 50 characters.\n* inPersonSignerName - Optional, if the template role is an in person signer, this is the full legal name of the signer. This can be a maximum of 100 characters.\n* emailNotification - This is an optional complex element that has a role specific emailSubject, emailBody, and language. It follows the same format as the emailNotification node for Recipients.\n* tabs - This allows the tab values to be specified for matching to tabs in the template.
     * @return $this
     */
    public function setTemplateRoles($template_roles)
    {
        
        $this->template_roles = $template_roles;
        return $this;
    }
    ...
    {
        return $this->composite_templates;
    }
    ...
    public function setCompositeTemplates($composite_templates)
    {
        ...
        $this->composite_templates = $composite_templates;
        return $this;
    }
    ...
    /**
     * Sets accessibility
     * @param string $accessibility Sets the document reading zones for screen reader applications.  This element can only be used if Document Accessibility is enabled for the account. \n\n#### Note: This information is currently generated from the DocuSign web console by setting the reading zones when creating a template, exporting the reading zone string information, and adding it here.
     * @return $this
     */
    ...
    /**
     * Sets purge_state
     * @param string $purge_state Initiates a purge request. Valid values are:\n* documents_queued: Places envelope documents in the purge queue.\n* documents_and_metadata_queued: Places envelope documents and metadata in the purge queue.
     * @return $this
     */
