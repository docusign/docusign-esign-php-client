 ...
 *
 * @category    Class
 * @description A tab that allows the recipient the option of declining an envelope. If the recipient clicks the tab during the signing process, the envelope is voided.
 * @package     DocuSign\eSign
 * @author      Swagger Codegen team <apihelp@docusign.com>
 * @license     The DocuSign PHP Client SDK is licensed under the MIT License.
 * @link        https://github.com/swagger-api/swagger-codegen
...
class Decline implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \DocuSign\eSign\Model\PropertyMetadata $button_text_metadata Metadata that indicates whether the `buttonText` property is editable.
     *
     * @return $this
     */
     ...
     *
     * @param \DocuSign\eSign\Model\PropertyMetadata $decline_reason_metadata Metadata that indicates whether the `declineReason` property is editable.
     *
     * @return $this
     */
