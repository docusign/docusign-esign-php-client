...
/**
 * DelayedRoutingApiModel Class Doc Comment
 *
 * @category    Class
 * @package     DocuSign\eSign
 * @author      Swagger Codegen team <apihelp@docusign.com>
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DelayedRoutingApiModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'delayedRoutingApiModel';
     ...
     * Sets rules
     *
     * @param \DocuSign\eSign\Model\EnvelopeDelayRuleApiModel[] $rules A list of envelope delay rules specified by the user indicating how and when the envelope should be sent in the future for the current workflow step and its associated recipients. Currently only 1 rule may be specified.
     *
     * @return $this
     */
