...
use \ArrayAccess;
/**
 * RecipientsUpdateSummary Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     DocuSign\eSign
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecipientsUpdateSummary implements ArrayAccess
{
    /**
    ...
    /**
      ...
      * @var \DocuSign\eSign\Model\RecipientUpdateResponse[]
      */
    protected $recipient_update_results;
    ...
    {
        if ($data != null) {
            $this->recipient_update_results = $data["recipient_update_results"];
        }
    }
    ...
    {
        return $this->recipient_update_results;
    }
    ...
    public function setRecipientUpdateResults($recipient_update_results)
    {
        ...
        $this->recipient_update_results = $recipient_update_results;
        return $this;
    }
