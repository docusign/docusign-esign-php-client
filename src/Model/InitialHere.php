...
class InitialHere implements ArrayAccess
{
    ...
    /**
      * $scale_value Sets the size for the InitialHere tab. It can be value from 0.5 to 1.0, where 1.0 represents full size and 0.5 is 50% size.
      * @var object
      */
    ...
    /**
     * Sets scale_value
     * @param object $scale_value Sets the size for the InitialHere tab. It can be value from 0.5 to 1.0, where 1.0 represents full size and 0.5 is 50% size.
     * @return $this
     */
