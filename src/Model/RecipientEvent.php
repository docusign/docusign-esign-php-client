 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecipientEvent implements ArrayAccess
{
    /**
    ...
    static $setters = array(
        'recipient_event_status_code' => 'setRecipientEventStatusCode',
    ...
    static $getters = array(
        'recipient_event_status_code' => 'getRecipientEventStatusCode',
        'include_documents' => 'getIncludeDocuments'
    );
  
    
    /**
      * $recipient_event_status_code The recipient status, this can be Sent, Delivered, Completed, Declined, AuthenticationFailed, and AutoResponded.
      * @var string
      */
    protected $recipient_event_status_code;
    ...
    {
        if ($data != null) {
            $this->recipient_event_status_code = $data["recipient_event_status_code"];
    ...
    {
        return $this->recipient_event_status_code;
    }
     ...
     * @return $this
     */
    public function setRecipientEventStatusCode($recipient_event_status_code)
    {
        
        $this->recipient_event_status_code = $recipient_event_status_code;
        return $this;
    }
