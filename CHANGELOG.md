...
## [4.13.0-rc] - ESignature API v2-21.3.00.00 - 2021-09-20
### Changed
- Added support for version v2-21.3.00.00 of the DocuSign ESignature API.
- Updated the SDK release version.


## [v4.12.0] - ESignature API v2-21.2.02.00 - 2021-09-02
### Changed
- Added support for version v2-21.2.02.00 of the DocuSign ESignature API.
- Updated the SDK release version.


## [v4.12.0-rc] - ESignature API v2-21.2.02.00 - 2021-08-19
### Changed
- Added support for version v2-21.2.02.00 of the DocuSign ESignature API.
- Updated the SDK release version.


## [v4.11.0] - eSignature API v2-21.2.00.00 - 2021-07-22
### Changed
...
## [4.9.0] - eSignature API v2-21.1.01.03 - 2021-04-23
### Added
